...
def fetch_knmi_prec_evap(station: int, start_date: str, end_date: str):
    ...
    Returns:
    - prec (pd.Series): Precipitation series in m/day (float64)
    - evap (pd.Series): Evapotranspiration series in m/day (float64)
    """
